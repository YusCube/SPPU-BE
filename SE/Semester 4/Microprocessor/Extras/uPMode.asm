;Assignment 6
;Aim:
;Write an ALP to check mode of processor (Real or Protected), then read GDTR, IDTR, LDTR, TR, MSW and displays the same.
;------------------------------------------------------------------------------------
section .data
	 nline                db        10,10
            nline_len:         equ      $-nline
...
;----------------------------------------------------------------
;OUTPUT:
;[shivasaran@sss-ragemachine Nasm]$ nasm -f elf64 uPMode.asm
;[shivasaran@sss-ragemachine Nasm]$ ld -o uPMode uPMode.o
;[shivasaran@sss-ragemachine Nasm]$ ./uPMode
;
;Processor is in Protected Mode...
;GDTR (Global Descriptor Table Register)          : FBC49000:007F
;IDTR (Interrupt Descriptor Table Register)       : FF57B000:0FFF
