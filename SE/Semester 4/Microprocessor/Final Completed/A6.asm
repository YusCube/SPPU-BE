;In this program first check the mode of processor(Real or Protected), then reads GDTR, LDTR and IDTR and displays the same.
...
;bash-4.3$ cd MLA27
;bash-4.3$ nasm -f elf64 A6.asm
;bash-4.3$ ld -o A6 A6.o
;bash-4.3$ ./A6
;Welcome

;Processor is in Protected Mode
;GDT Contents are::7A089000:007F
;LDT Contents are::0000
;IDT Contents are::FF56B000:0FFFbash-4.3$
