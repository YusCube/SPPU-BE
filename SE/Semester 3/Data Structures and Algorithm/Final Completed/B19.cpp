...
Enter first 4 digit binary number = 1
0
0
1
...
Linked List is:= 1	0	0	1	
Enter second 4 digit binary number = 1
0
1
0
...
Linked List is:= 0	1	1	0	
1's Complement of Second Binary Number=

Linked List is:= 0	1	0	1	
---------PROGRAM MENU---------
 1.Create head node of Two Binary Numbers
 2.Insert number or node ( Binary Number) 
 3.1's Complement of Two Binary Numbers
