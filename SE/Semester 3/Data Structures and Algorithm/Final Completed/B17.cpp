	...
	while(1)
	{
		...
		switch(ch)
		{
			case 1:
				...
				cin>>sizeB;
				cout<<"\nEnter roll numbers of set B "<<sizeB<<" students (like butterscotch Ice-cream):= ";
...
Enter how many students in class Second year Computer Engineering:= 15

Enter size of set A students (like Vanilla Ice-cream):=6

Enter roll numbers of set A 6 students (like Vanilla Ice-cream):= 1 2 5 7 12 21

Enter size of set B students (like butterscotch Ice-cream):=4

Enter roll numbers of set B 4 students (like butterscotch Ice-cream):= 12 27 2 3
...
Number of students who like neither vanilla nor butterscotch= 7
----------Menus----------
1. Create Linked List 
2. Set of students who like either vanilla or butterscotch or both 
3. Set of students who like both vanilla and butterscotch 
